...
/* NetIds: bx83.
 * What I thought about this assignment: The practice is good but I think I need answers after the assignment.
 *
 *
 *
 *  */
...
public class A3 {
    ...
    public static double timeSpent= 3.0;
    ...
    public static String protectLittles(String s) {
        ...
        for (int i=0; i<s.length(); i++) {
        	if (s.charAt(i)>='a' && s.charAt(i)<='z') {
        		 sb.append(String.valueOf(Character.toUpperCase(s.charAt(i)))+String.valueOf(s.charAt(i)));
        	}
        	else {
        		sb.append(s.charAt(i));
        	}
        }
        return newS = sb.toString();
    }
    ...
    public static String putCapsLast(String s) {
    	...
    	for (int i=0; i<s.length(); i++) {
    		if (s.charAt(i)>='A' && s.charAt(i)<='Z') {
    			...
    			sbc.append(String.valueOf(s.charAt(i)));
    		}
    	}
    	return sbc.toString()+sb.toString();
    }
    ...
    * expand("35")          is "33333". */
    public static String expand(String s) {
    	...
    	String str = "";
        String s1 = s.trim();
        for (int i=0; i<Character.getNumericValue(s1.charAt(1)); i++){
        	str = str + s1.charAt(0);
        }
        return str;
    }
