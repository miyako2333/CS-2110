 ...
 * 1. Name: Bin Xu
 * 2. Netid: bx83
 * 3. Took CS1110 (yes or no): no
 * 4: Took CS1112 (yes or no): no
 * 5. I know Java (yes or no): no
 * 6. Tell is what you thought of this assignment: 
 *    Compared to A1 Elephant, I feel this assignment is far more
 *    straight forward and easy to understand, what to output,
 *    it is very clear.
 *
 *
 */
 ...
 * suggestions for writing it and perhaps showing you where to look in<br>
...
public class A2 {
    ...
    public static int loop5(int n) {
         ...
         * Use   n%2 == 0   to test whether n is even.
         *
         * When you have completed this, be sure to fill in the information
         * in the comment at the top of this class, including what you
         * thought of this assignment. */
    	while (n % 2 == 0) {
    		n = n / 2;
    	}
        return n;
