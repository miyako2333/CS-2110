...
class A2Test {
	...
	@Test
	void testSum1() {
		assertEquals(30, A2.sum1());
	}

	@Test
	void testSum2() {
		assertEquals(0, A2.sum2(0));
		assertEquals(30, A2.sum2(6));
	}

	@Test
	void testSum3() {
		assertEquals(9, A2.sum3(4, 5));
		assertEquals(7, A2.sum3(0, 5));
	}

	@Test
	void testSum4() {
		assertEquals(12, A2.sum4(4, 5));
		assertEquals(12, A2.sum4(4, 2));
	}
